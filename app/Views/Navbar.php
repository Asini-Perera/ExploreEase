...
<nav class="nav-container" aria-label="Main Navigation">
    <ul class="menu-items">
        ...
        <li class="menu-item services"><a href="http://localhost/ExploreEase/loged_home#services-features">Services</a></li>
        <li class="menu-item services"><a href="http://localhost/ExploreEase/logout">Logout</a></li>
