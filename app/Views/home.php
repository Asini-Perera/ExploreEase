...
<section class="register" id="register">
            ...
            <div>
                <img src="#">
                <h2>Register with us as a Traveller</h2>
                <p>Register with us. We make your journey more 
                    comfortable in our platform.</p>
                <button>Register</button>
            </div>

            <div>
                <img src="#">
                <h2>Register with us as a Service Provider</h2>
                <p>Register with us to promote your services and 
                    We connect you and travellers through our platform.</p>
                <button>Register</button>
            </div>
            </div>
        </section>
