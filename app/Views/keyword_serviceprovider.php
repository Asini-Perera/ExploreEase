...
<body>
    ...
    <form action="keywords.php">
        <label for="travel">1.Travel</label><br>
        ...
        <label for="accommodation">2.Accommodation</label><br>
        ...
        <label for="transport">3.Transportation</label><br>
        ...
        <label for="food">4.Food & Drink</label><br>
        ...
        <label for="activities">5.Activities</label><br>
