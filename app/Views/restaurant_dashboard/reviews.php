...
<!-- post_list -->
<section class="post_list" id="post_list" style="margin-top: 2vh;  margin-left: 15vw; width: 84vw; height:84vh; background-color: #D9D9D9;  overflow: hidden; overflow-y:scroll;
