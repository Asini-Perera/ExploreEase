...
<body>
    ...
    <div class="main-container">
        <header>
            <div class="container">
                <h1 class="h-name">ABC Hotel</h1>
                <h3 class="describe"> Make Yourself At Home In Our Hotel</h3>
            </div>
        </header>
        ...
        <section class="about-section" id="about">
            ...
            <div class="about">
                <div class="content">
                    ...
                    <p class="description">ABC Hotel is your home away from home, offering a cozy and relaxing atmosphere for all travelers. Located in a prime spot, we provide modern and comfortable rooms, delicious dining options, and friendly service.We make your stay even easier with our online booking services, allowing you to reserve rooms, dining tables, or special event spaces in just a few clicks. Whether you're here for business, a family vacation, or a romantic getaway, our hotel features additional amenities like free Wi-Fi, a fitness center, a swimming pool, and 24/7 customer support.
                        At ABC Hotel, your comfort and convenience come first. Let us make your visit truly memorable!</p>
                </div>
            </div>
        </section>
        ...
        <section class="bookings" id="bookings">
            ...
            <div class="booking-form">
                <h2 style="text-align: center; font-size:18px; padding-bottom:20px;">Book Your Stay</h2>
                ...
                <form action="/submit-booking" method="post">
                    ...
                    <div id="extras">
                        ...
                        <label><input type="checkbox" name="lunch" value="breakfast-in-bed">Lunch</label>
                        <label><input type="checkbox" name="dinner" value="city-tour">Dinner</label>
                        <label><input type="checkbox" name="all" value="spa-access">All Meals</label>
        ...
        <section class="contact_us">
            ...
            <div class="share">
                <a href="https://www.twitter.com/"><img class="#######" alt="" src="../public/images/twitter.png"></img></a>
                <a href="https://www.facebook.com/"><img class="#######" alt="" src="../public/images/facebook.png"></img></a>
                <a href="https://www.instagram.com/"><img class="#######" alt="" src="../public/images/instagram.png"></img></a>
                <a href="https://www.youtube.com/"><img class="#######" alt="" src="../public/images/youtube.png"></img></i></a>
            </div>
        </section>
    </div>
