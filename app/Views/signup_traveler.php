...
<body>
    ...
    <form action="traveler_form_signup.php" method="post">
        ...
        <input type="radio" id="male" name="gender" value="male" title="Male"> Male
        <input type="radio" id="female" name="gender" value="female" title="Female"> Female<br><br>
